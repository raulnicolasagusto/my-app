{/* Seguimos en el minuto 3:12:36 del video https://www.youtube.com/watch?v=17VzlB35Ixw&t=6609s */}
...
async function CoursePage({ params }: CoursePageProps) {
    ...
    if(!course) {
        return <div className="container mx-auto px-4 py-8 mt-16">
                    <h1 className="text-4xl font-bold">Course not found || No se encontro el curso</h1> 
                </div>;
    }
